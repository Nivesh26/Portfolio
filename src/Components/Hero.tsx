...
const Hero = () => {
  return (
    <section className="relative h-svh min-h-[640px] overflow-hidden bg-[#F3F3F1]">
      ...
      <p
        aria-hidden
        className="hero-name pointer-events-none absolute top-[7%] left-1/2 z-0 w-[96%] -translate-x-1/2 text-center font-['Archivo_Black'] text-[clamp(2.6rem,9vw,7.25rem)] leading-none tracking-[-0.045em] text-[#14171C]/90 uppercase select-none"
      >
        NIVESH SHRESTHA
      </p>
